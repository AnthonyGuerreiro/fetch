...
// TODO obtain information what it is downloading through
// events for better error messages
public class Transmission implements BitTorrentClient {
    ...
    public List<TorrentInfo> getAllTorrentsInfo() throws DownloadManagerException {
        try {
            ...
            List<nl.stil4m.transmission.api.domain.TorrentInfo> torrentsInfo = client
                    .getAllTorrentsInfo().getTorrents();
